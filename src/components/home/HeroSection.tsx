    ...
    <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-gradient-to-r from-gray-900 to-gray-800">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            <span className="text-cornflower-blue"> ~</span> Be 
            <span className="text-cornflower-blue"> Silent! </span><br />
            When It Is Time To 
          ...
          >
            ~ <b className="text-cornflower-blue">Snigdha OS</b> revolutionizes penetration testing with a user-friendly suite of tools, improving accuracy, speed, and performance. Whether you're a beginner or an expert, Snigdha OS simplifies complex testing processes and enhances security assessments.
          </motion.p>
